...
describe("API Routes", () => {
  ...
  // Blockchain route coverage lives in blockchain.route.test.js, which
  // mounts the real src/api/routes/blockchain.route.ts router instead of a
  // disconnected hand-written mock.
  // ─── Committee Routes ─────────────────────────────────────────────────────
